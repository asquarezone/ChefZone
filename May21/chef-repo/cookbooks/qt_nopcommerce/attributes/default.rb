default['qt_nopcommerce']['microsoft_key']['url'] = 'https://referenceapplicationskhaja.s3.us-west-2.amazonaws.com/packages-microsoft-prod.deb'
...
default['qt_nopcommerce']['additional_dirs'] = ['/var/www/nopCommerce440/bin','/var/www/nopCommerce440/logs']